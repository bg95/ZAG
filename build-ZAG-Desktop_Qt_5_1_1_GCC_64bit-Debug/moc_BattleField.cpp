...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_BattleField_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 25, 7)
    ...
    "BattleField\0start\0\0pause\0refresh\0"
};
...
const QMetaObject BattleField::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_BattleField.data,
      qt_meta_data_BattleField,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BattleField.stringdata))
